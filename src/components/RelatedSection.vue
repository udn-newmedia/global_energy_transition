<template>
  <div class="related-section-container">
    <div v-if="isMob" class="related-section related-section-mob">
      ...
      >
        <a href="" name="日本能源" class="related-article">
...
.related-section-container {
  ...
  .related-section-mob {
    background-image: url('../assets/mob/global_energy_transition_Japan_background_image_m.jpg');
    background-position: 75% 0;
    @media only screen and (min-width: 768px) {
      background-image: url('../assets/pad/global_energy_transition_Japan_background_image_pad.jpg');
      background-position: 95% 0;
    }
  }
  .related-section-pc {
    background-image: url('../assets/pc/global_energy_transition_Japan_background_image.jpg');
  }
}
</style>